...
{
    [PublicAPI]
    public interface IOcThreadSafeDictionary<TK, TV> : IDictionary<TK, TV>
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns an <see cref="IDisposable"/> that represents a write lock for use with a C# using statement.
        /// WARNING: You *MUST* call the <see cref="IOcLockReadWrite.Lock"/> to activate the lock as the first thing within the using block.
        /// </summary>
        [NotNull] IOcLockReadWrite WriteLock();
    }
}