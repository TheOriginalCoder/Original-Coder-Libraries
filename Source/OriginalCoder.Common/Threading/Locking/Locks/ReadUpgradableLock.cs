...
{
    /// <summary>
    /// For holding and releasing a Read lock that can be upgraded to a write lock but do not allow a write lock from being directly obtained.
    /// </summary>
    internal sealed class ReadUpgradableLock : IOcLockReadUpgrade
    {
        internal ReadUpgradableLock(OcThreadLockUpgradableBase tl)
        {
