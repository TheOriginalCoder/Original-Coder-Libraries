...
namespace OriginalCoder.Common.Extensions
{
	...
	public static class TypeExtensions
	{
        ...
        /// <summary>
        /// Returns the name of <paramref name="type"/> so that it is nicely formatted and human readable.
        /// This method automatically handles things like generics and nested types.
        /// </summary>
        public static string FriendlyName(this Type type)
        {
            ...
            if (type.IsGenericType)
            {
                ...
                for (var i=0; i<typeArgs.Length; i++)
                    result += (i == 0 ? "" : ", ") + FriendlyName(typeArgs[i]);
                result += ">";
            }
            return result;
        }
