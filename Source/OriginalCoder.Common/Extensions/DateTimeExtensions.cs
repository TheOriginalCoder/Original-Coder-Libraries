...
namespace OriginalCoder.Common.Extensions
{
    ...
    public static class DateTimeExtensions
    {
      #region Output to display to user
        ...
        public static string ToDisplayDate(this DateTime value, IOcDateTimeConfiguration configuration = null)
        {
        ...
        public static string ToDisplayTime(this DateTime value, IOcDateTimeConfiguration configuration = null)
        {
            configuration = configuration ?? OcDateTimeConfiguration.GlobalDefaults;
      ...
      #region Output to storage
        ...
        /// <param name="configuration">Configuration options to use.  If null <see cref="OcDateTimeConfiguration.GlobalDefaults"/> will be used. </param>
        /// <returns>A string containing the formatted date.</returns>
        public static string ToStorageDate(this DateTime value, IOcDateTimeConfiguration configuration = null)
        {
            configuration = configuration ?? OcDateTimeConfiguration.GlobalDefaults;
        ...
        /// <param name="configuration">Configuration options to use.  If null <see cref="OcDateTimeConfiguration.GlobalDefaults"/> will be used. </param>
        /// <returns>A string containing the formatted time.</returns>
        public static string ToStorageTime(this DateTime value, IOcDateTimeConfiguration configuration = null)
        {
            configuration = configuration ?? OcDateTimeConfiguration.GlobalDefaults;
      ...
      #region Parse text into a DateTime (text format should be similar to the storage foramt)
        ...
        public static DateTime ToDate(this string text, IOcDateTimeConfiguration configuration = null)
        {
            configuration = configuration ?? OcDateTimeConfiguration.GlobalDefaults;
        ...
        public static DateTime ToDateTimeAsUtc(this string text, IOcDateTimeConfiguration configuration = null)
        {
            configuration = configuration ?? OcDateTimeConfiguration.GlobalDefaults;
            foreach (var culture in configuration.InputCultures)
        ...
        /// <param name="configuration">Configuration options to use.  If null <see cref="OcDateTimeConfiguration.GlobalDefaults"/> will be used. </param>
        /// <returns>A DateTime that only contains time information.</returns>
        public static DateTime ToTimeAsLocal(this string text, IOcDateTimeConfiguration configuration = null)
        {
            configuration = configuration ?? OcDateTimeConfiguration.GlobalDefaults;
            foreach (var culture in configuration.InputCultures)
      ...
      #region Attempt parsing of text into a DateTime (text format should be similar to the storage foramt)
        ...
        /// <param name="configuration">Configuration options to use.  If null <see cref="OcDateTimeConfiguration.GlobalDefaults"/> will be used. </param>
        /// <returns>A DateTime that only contains date information.</returns>
        public static bool TryToDate(this string text, out DateTime result, IOcDateTimeConfiguration configuration = null)
        {
            configuration = configuration ?? OcDateTimeConfiguration.GlobalDefaults;
            foreach (var culture in configuration.InputCultures)
            {
        ...
        /// <param name="configuration">Configuration options to use.  If null <see cref="OcDateTimeConfiguration.GlobalDefaults"/> will be used. </param>
        /// <returns>A DateTime that only contains time information.</returns>
        public static bool TryToTimeAsUtc(this string text, out DateTime result, IOcDateTimeConfiguration configuration = null)
        {
            configuration = configuration ?? OcDateTimeConfiguration.GlobalDefaults;
            foreach (var culture in configuration.InputCultures)
            {
        ...
        /// <param name="configuration">Configuration options to use.  If null <see cref="OcDateTimeConfiguration.GlobalDefaults"/> will be used. </param>
        /// <returns>A DateTime that contains both date and time information.</returns>
        public static bool TryToDateTimeAsLocal(this string text, out DateTime result, IOcDateTimeConfiguration configuration = null)
        {
            configuration = configuration ?? OcDateTimeConfiguration.GlobalDefaults;
            foreach (var culture in configuration.InputCultures)
            {
