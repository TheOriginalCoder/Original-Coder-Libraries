...
{
    /// <summary>
    /// Concrete implementation of <see cref="IOcDateTimeConfiguration"/>.
    /// Default configuration options are specified by the static <see cref="GlobalDefaults"/> property.
    /// </summary>
    [PublicAPI]
    public class OcDateTimeConfiguration : IOcDateTimeConfiguration
    {
      #region Global Configuration (defaults used by extension methods)

        /// <summary>
        /// Specifies the <see cref="IOcDateTimeConfiguration"/> that will be used by
        /// default for operations that don't specify an <see cref="IOcDateTimeConfiguration"/>.
        /// </summary>
        public static IOcDateTimeConfiguration GlobalDefaults { get; private set; } = new OcDateTimeConfiguration();
      ...
      #region Constructors
        ...
        /// <summary>
        /// Instantiates an object that implements <see cref="IOcDateTimeConfiguration"/> and uses the defaults built into the OriginalCoder library.
        /// </summary>
        public OcDateTimeConfiguration()
            : this(
                ...
                OcDateTimeConstants.StorageDateFormat, 
                OcDateTimeConstants.StorageTimeFormat, 
                OcDateTimeConstants.StorageDateTimeFormat, 
                new List<IFormatProvider> {CultureInfo.InvariantCulture}, 
                OcDateTimeConstants.ParserDateFormats, 
                OcDateTimeConstants.ParserTimeFormats, 
                OcDateTimeConstants.ParserDateTimeFormats
            )
        { }

        /// <summary>
        /// Instantiates an object that implements <see cref="IOcDateTimeConfiguration"/> with a custom configuration.
        /// </summary>
        public OcDateTimeConfiguration(
