...
{
    [PublicAPI]
    public abstract class OcLayerAdapterCrudSearchBase<TRequest, TEntity, TKey, TSearch, TNextEntity, TNextLayer> : OcLayerAdapterCrudBase<TRequest, TEntity, TKey, TNextEntity, TNextLayer>, IOcLayerCrudSearch<TRequest, TEntity, TKey, TSearch>
        where TRequest : class, IOcRequest
        where TEntity : class
        where TSearch : class
        where TNextEntity : class
        where TNextLayer : class, IOcLayerCrudSearch<TRequest, TNextEntity, TKey, TSearch>
    {
      #region Constructors
        ...
        protected OcLayerAdapterCrudSearchBase([NotNull] IOcLayerConfiguration<TRequest> configuration, OcLayerType layerType, string resourceName, [NotNull] TRequest request, TNextLayer nextLayer)
        ...
        /// <param name="request"></param>
        /// <param name="nextLayer"></param>
        protected OcLayerAdapterCrudSearchBase([NotNull] IOcLayerConfiguration<TRequest> configuration, [NotNull] string layerTypeName, string resourceName, [NotNull] TRequest request, TNextLayer nextLayer)
        ...
        protected OcLayerAdapterCrudSearchBase([NotNull] IOcLayerConfiguration<TRequest> configuration, OcLayerType layerType, string resourceName, [NotNull] TRequest request, OcLayerType nextLayerType)
        ...
        protected OcLayerAdapterCrudSearchBase([NotNull] IOcLayerConfiguration<TRequest> configuration, [NotNull] string layerTypeName, string resourceName, [NotNull] TRequest request, OcLayerType nextLayerType, string nextLayerTypeName)
