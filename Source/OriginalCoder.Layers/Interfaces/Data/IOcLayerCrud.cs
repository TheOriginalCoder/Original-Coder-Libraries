...
{
    /// <summary>
    /// Layer implementation of Read/Write data operations using the interface <see cref="IOcDataCrud{TEntity,TKey}"/>
    /// </summary>
    ...
    [PublicAPI]
    public interface IOcLayerCrud<out TRequest, TEntity, TKey> : IOcDataCrud<TEntity, TKey>, IOcLayerRead<TRequest, TEntity, TKey>
