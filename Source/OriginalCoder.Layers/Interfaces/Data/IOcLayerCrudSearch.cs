...
{
    /// <summary>
    /// Layer implementation of Read/Write and Search data operations using the interface <see cref="IOcDataCrudSearch{TEntity,TKey,TSearchParams}"/>
    /// </summary>
    ...
    [PublicAPI]
    public interface IOcLayerCrudSearch<out TRequest, TEntity, TKey, in TSearch> : IOcDataCrudSearch<TEntity, TKey, TSearch>, IOcLayerReadSearch<TRequest, TEntity, TKey, TSearch>, IOcLayerCrud<TRequest, TEntity, TKey>
