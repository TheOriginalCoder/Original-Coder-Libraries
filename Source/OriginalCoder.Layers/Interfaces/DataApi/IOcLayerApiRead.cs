...
{
    /// <summary>
    /// Layer implementation of Read API operations using the interface <see cref="IOcDataApiRead{TEntity,TKey}"/>
    /// </summary>
    ...
    [PublicAPI]
    public interface IOcLayerApiRead<out TRequest, out TEntity, in TKey> : IOcDataApiRead<TEntity, TKey>, IOcLayer<TRequest>
