...
{
    /// <summary>
    /// Layer implementation of Read and Search API operations using the interface <see cref="IOcDataApiReadSearch{TEntity,TKey,TSearchParams}"/>
    /// </summary>
    ...
    [PublicAPI]
    public interface IOcLayerApiReadSearch<out TRequest, out TEntity, in TKey, in TSearch> : IOcDataApiReadSearch<TEntity, TKey, TSearch>, IOcLayerApiRead<TRequest, TEntity, TKey>
