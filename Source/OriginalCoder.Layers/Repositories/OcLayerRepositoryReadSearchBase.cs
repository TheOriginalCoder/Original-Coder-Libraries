...
{
    [PublicAPI]
    public abstract class OcLayerRepositoryReadSearchBase<TRequest, TEntity, TKey, TSearch> : OcLayerRepositoryReadBase<TRequest, TEntity, TKey>, IOcLayerReadSearch<TRequest, TEntity, TKey, TSearch>
        ...
        where TSearch : class
    {
      #region Constructors
        ...
        protected OcLayerRepositoryReadSearchBase([NotNull] IOcLayerConfiguration<TRequest> configuration, OcLayerType layerType, string resourceName, [NotNull] TRequest request)
            : base(configuration, layerType, resourceName, request)
        { }

        protected OcLayerRepositoryReadSearchBase([NotNull] IOcLayerConfiguration<TRequest> configuration, [NotNull] string layerTypeName, string resourceName, [NotNull] TRequest request)
